...
import { getAllOrderDeliver } from "../features/delivery/deliverySlice";
import { addOrderforShipper } from "../features/auth/authSlice";

const Addorderbydelivery = () => {
          ...
          <>
            <button
              ...
              onClick={() => {
                ...
                setTimeout(() => dispatch(getAllOrderDeliver()), 500);
              }}
            >
              {" "}
              <AiOutlinePlusCircle />
...
export default Addorderbydelivery;
